...
namespace BPBTree{
	[Name("Scene事件_显示对话--2")]
	[Description("在Scene上显示对话--2")]
	public class BT_Test_hotfix : ActionTask
    {
		public string text;
		...
		protected override void OnExecute()
		{
            ...
            if(go != null)
            {
                ...
                UnityEngine.Debug.Log($"热更新行为树 ==> {mono.btText}");
            }
            else
            {
                UnityEngine.Debug.Log($"热更新行为树 获取 {BPDefine.MAIN_GO_NAME} 为null");
            }
            EndAction(true);
		}
